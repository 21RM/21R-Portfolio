...
const skills: Skill[] = [
  { name: 'Game Physics', level: 90, category: 'gamedev' },
  { name: 'GDScript', level: 85, category: 'programming' },
  { name: 'Godot Engine', level: 85, category: 'gamedev' },
  { name: 'Procedural Generation', level: 82, category: 'gamedev' },
  { name: 'Python', level: 81, category: 'programming' },
  { name: 'C++', level: 80, category: 'programming' },
  { name: 'C', level: 80, category: 'programming' },
  { name: 'PHP', level: 75, category: 'programming' },
  { name: 'HTML/CSS', level: 75, category: 'programming' },
  { name: 'SQL', level: 67, category: 'programming' },
  { name: '3D Rendering', level: 65, category: 'gamedev' },
  { name: 'GLSL', level: 60, category: 'programming' },
  { name: 'JavaScript', level: 60, category: 'programming' },
  { name: 'Haskell', level: 58, category: 'programming' },
  { name: 'C#', level: 50, category: 'programming' },
  { name: 'Java', level: 50, category: 'programming' },
  { name: 'Assembly', level: 48, category: 'programming' },
  { name: 'Dart', level: 25, category: 'programming' },
  { name: 'Unity', level: 32, category: 'gamedev' },
  { name: 'Portuguese', level: 100, category: 'languages' },
  { name: 'English', level: 90, category: 'languages' },
];

const Skills: React.FC = () => {
  const [activeCategory, setActiveCategory] = useState<'all' | 'programming' | 'gamedev' | 'languages'>('programming');
